Let's see what I did to create this react app from a youtube tutorial.

first I create a folder with:
npx create-react-app folder_name

then go in the src folder and add bootstrap in index.js:
// to add bootstrap i did :
//      in the terminal: npm i bootstrap@4.1.1
//      and then i wrote the line below:
import 'bootstrap/dist/css/bootstrap.css';

then i add a new folder named components in the src folder

then in the components folder I create a new file named counter.jsx (cameCase very important) It seems to be better to use .jsx instead of .js
and I create a first component

then i go back to index.js and add:
import Counter from './components/Counter';
and change the render line by:
ReactDOM.render(<Counter />, document.getElementById('root'));

Now I add a button to counter.jsx
Let's remember:
if there is more than one element (tag) to render, they have to be wrapped inside one element (div for example)
if we don't want to wrap all this in a div that we don't need/want, we can use:
<React.Fragment></React.Fragment> instead
